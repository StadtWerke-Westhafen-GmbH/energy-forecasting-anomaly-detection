  ...
  return (
    <>
      <PageHeader eyebrow="Betrieb" title={"Portfolio-Übersicht " + monat}
        ...
        actions={<><Button variant="secondary" icon="download" disabled title="Für eine echte Anwendung eine Exportfunktion anbinden">Export</Button><Button variant="primary" icon="trending-up" disabled title="Kein Prognosemodell angebunden">Prognose 04/2025</Button></>} />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.9fr 1fr", gap: "var(--space-4)", marginBottom: "var(--space-4)" }}>
        ...
        <Card title="Anomalien nach Kundentyp" subtitle={monat} icon="chart-column"
          ...
          <Chart height={272} layout={{ margin: { l: 44, r: 12, t: 20, b: 40 }, showlegend: false, yaxis: { title: { text: "Zähler" }, range: [0, Math.max(...Object.values(D.anomalienNachTyp)) * 1.2] } }}
            data={[{
              ...
              textfont: { family: "IBM Plex Sans, sans-serif", size: 12, color: window.SWWTokens.tokens["text-muted"] },
            }]} />
        </Card>
      </div>
