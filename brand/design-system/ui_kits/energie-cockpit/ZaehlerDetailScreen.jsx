      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.9fr 1fr", gap: "var(--space-4)", marginBottom: "var(--space-4)" }}>
        <Card title="Prognose vs. Ist" subtitle="24 Monate, Verbrauch in kWh" icon="trending-up"
          ...
          <Chart height={280} layout={{ yaxis: { title: { text: "Verbrauch (kWh)" } }, margin: { l: 74, r: 18, t: 30, b: 42 } }}
            data={[
              ...
              { x: z.anomalieIdx.map((i) => D.MONATE[i]), y: z.anomalieIdx.map((i) => z.historie[i]), name: "Anomalie", mode: "markers", type: "scatter", marker: { size: 10, color: ROLE.anomalie, line: { width: 1.5, color: window.SWWTokens.tokens["surface-card"] } } },
            ]} />
        </Card>
        ...
        <Card title="Residuen" subtitle="Ist − Prognose, kWh" icon="activity" footer={"Schwellwert ± " + D.fmt(schwelle) + " kWh"}>
          <Chart height={280} layout={{
            ...
            yaxis: { title: { text: "Residuum (kWh)" }, zeroline: true, zerolinecolor: window.SWWTokens.tokens["grey-300"], zerolinewidth: 1 },
            shapes: [
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.3fr", gap: "var(--space-4)" }}>
        ...
        <Card title="Einflussfaktoren" subtitle="Feature Importance, Random-Forest-Regressor" icon="chart-column"
          ...
          <Chart height={250} layout={{
            ...
            xaxis: { title: { text: "Anteil" }, showgrid: true, gridcolor: window.SWWTokens.tokens["grey-100"], showline: false },
            yaxis: { showgrid: false, tickfont: { family: "IBM Plex Sans, sans-serif", size: 11, color: window.SWWTokens.tokens["text-muted"] } },
          }}
            data={[{
              ...
              textposition: "outside", textfont: { family: "IBM Plex Sans, sans-serif", size: 11, color: window.SWWTokens.tokens["text-muted"] },
            }]} />
        </Card>
      </div>
    </>
