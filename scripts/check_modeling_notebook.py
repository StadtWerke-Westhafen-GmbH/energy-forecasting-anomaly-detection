"""Execute and validate the presentation-ready modeling notebook.

By default the notebook is executed in memory. Pass ``--update`` to persist
the verified outputs in ``notebooks/10_modeling.ipynb``.
"""
...
TARGET = ROOT / "notebooks" / "10_modeling.ipynb"
PROTECTED = (
...
def main() -> None:
    ...
    kernel_env = dict(os.environ, IPYTHONDIR=str(ROOT / ".build" / "ipython-modeling"))
