...
def main():
    ...
    for cell in notebook.cells:
        ...
        for output in cell.get("outputs", []):
            ...
            if "application/vnd.plotly.v1+json" in data:
                ...
                parts.append("<pre>" + escape(output.text) + "</pre>")
    ...
    main{{max-width:1120px;padding:32px 24px;margin:auto}}.sww-copy{{line-height:1.65;margin:32px 0}}
    ...
    @media(max-width:800px){{.sww-chart{{overflow-x:auto}}.sww-chart .plotly-graph-div{{min-width:760px}}}}
