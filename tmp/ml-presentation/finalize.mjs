...
const result=await finalizePresentation({
 ...
 finalPath:path.join(root,'docs/presentation/ML_Modellierung_Anomaliepruefung_SWW.pptx'),
 ...
 layoutArgs:['--expected-slide-size-emu','12192000,6858000','--validate-bullet-geometry','--validate-heading-fit',...[6,16,17].flatMap(n=>['--require-native-table-slide',String(n)])],
 explicitTotalSlideCount:18,
 requiredNativeChartOwnerSlides:[7,8,9,10,11,12,14,15,16,17],
 requiredNativeTableOwnerSlides:[6,16,17],
 ...
 receiptPath:path.join(dir,'ml-final.validation.json'),
});
