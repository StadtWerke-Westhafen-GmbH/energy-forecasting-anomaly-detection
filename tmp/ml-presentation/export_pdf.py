...
QA = BUILD / "pdf-render"
OUTPUT = ROOT / "docs/presentation/ML_Modellierung_Anomaliepruefung_SWW.pdf"
...
images = [SOURCE / f"slide-{i:02d}.png" for i in range(1, 19)]
...
pdf.setTitle("Machine Learning: Modellierung und Anomalieprüfung | SWW")
