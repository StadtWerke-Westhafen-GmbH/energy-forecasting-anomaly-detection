...
(function (global) {
  const C = {
    navy: "#084878", navy900: "#04263F", teal: "#0080A0", cyan: "#0090C8", green: "#58A858",
    amber: "#C77E11", red: "#B3261E", ink: "#141A21", grey600: "#4E5A68", grey500: "#6B7887",
    grey400: "#8C99A7", grey300: "#B4BFCB", grey100: "#E4E9EF", grey50: "#F1F4F7",
  };
  const QUALITATIVE = [C.navy, C.teal, C.green, C.cyan, C.amber, "#6CC0D2", C.grey600, C.red];
  const KT = { Gewerbe: C.teal, Industrie: C.navy, Kommunal: C.green };
  const ROLE = { ist: C.navy, prognose: C.cyan, band: "rgba(0,144,200,0.16)", residuum: C.teal, schwellwert: C.amber, anomalie: C.red };
  ...
  function layout(over) {
    const base = {
      ...
      paper_bgcolor: "#fff", plot_bgcolor: "#fff", separators: ",.", colorway: QUALITATIVE,
      margin: { l: 76, r: 18, t: 14, b: 40 }, hovermode: "x unified", bargap: 0.36, barcornerradius: 4,
      hoverlabel: { bgcolor: "#fff", bordercolor: C.grey100, font: { family: LABEL, size: 12, color: C.ink }, align: "left" },
      legend: { orientation: "h", yanchor: "bottom", y: 1.02, xanchor: "left", x: 0, font: { size: 12, color: C.grey500 }, bgcolor: "rgba(0,0,0,0)" },
      xaxis: axis(),
      yaxis: merge(axis(), { showgrid: true, gridcolor: C.grey100, showline: false, tickformat: ",d", separatethousands: true }),
    };
